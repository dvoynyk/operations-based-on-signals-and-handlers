...
int cl_2::get_number_class()       // Метод возвращения номера класса
{
	return 2;                      // Возвращение 2
}

void cl_2::signal(string& message) // Метод сигнала
{
...
void cl_2::handler(string message)                                              // Метод обработчика
{
